...
@section('page-title')
    <title>Yearly Orders  || {{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->company_name : 'Shop' }} </title>
@endsection
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title">
                            ...
                            <li class="breadcrumb-item"><a href="{{url('/admin/dashboard')}}">{{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->company_name : 'Shop' }}</a></li>
                                <li class="breadcrumb-item active">Manage Yearly Orders </li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">
                                Manage Orders
                                <span class="text-danger">({{date('Y')}})</span>
                                <div class="btn btn-group">
                                    ...
                                    <a href="{{route('year.order')}}" class="btn btn-primary" style="background: #0c7dc2;">This Year</a>
                                </div>
                            </h4>
                            <div class="data">
