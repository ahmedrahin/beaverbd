...
@section('page-title')
    <title>Manage All Orders  || {{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->company_name : 'Shop' }} </title>
@endsection
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title">
                                ...
                                <div class="btn btn-group">
                                    <a href="{{route('manage.order')}}" class="btn btn-primary" style="background: #0c7dc2;">All</a>
