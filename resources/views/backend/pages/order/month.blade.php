...
@section('page-title')
    <title>Manage  @if( Request::is('admin/order/month') ) This Month @else {{$getMonth}} @endif Orders  || {{ !is_null($siteTitle = App\Models\Settings::site_title()) ? $siteTitle->company_name : 'Shop' }} </title>
@endsection
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title">
                                @if( Request::is('admin/order/month') )
                                    This Month Orders
                                @else
                                    {{$getMonth}} Month Orders
                                @endif
                                ...
                                <div class="btn btn-group">
                                    ...
                                    <a href="{{route('today.order')}}" class="btn btn-primary">Today</a>
                                    <a href="{{route('month.order')}}" class="btn btn-primary" style="background: #0c7dc2;">This Month</a>
                ...
                <div class="row exp_info">
                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <div class="card-header">
                                Show Others Month's ({{$year}}) Orders
                            </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        @for($i = 1; $i <= 12; $i++)
                                            <?php 
                                                ...
                                                $buttonClass   = (Request::is('admin/order/monthly-order/'.strtolower($monthName))) ? 'btn-success' : 'btn-primary';
                                                $isMonth       = ( date('M') == $monthName && Request::is('admin/order/month') ) ? 'btn-success' : '';
                                            ?>
                                            <a href="{{ route('monthly.order', strtolower($monthName)) }}" class="btn {{ $buttonClass }} {{$isMonth}} {{ $disabled }}">
                                                {{ $monthName }}
                                            </a>
                                        @endfor
                                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row monthlyExpense">
                                    <form action="{{route('monthly.day.order')}}" method="GET">
