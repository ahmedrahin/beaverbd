            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{url('/')}}" class="logo logo-light">
                    <span class="logo-sm">
                        ...
                        @endphp
                        @if(!is_null($logo))
                            <img src="{{asset($logo->logo)}}" alt="logo-light" height="20" class="logo">
                        @endif
                    </span>
                    <span class="logo-lg">
                        <!--logo-->
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    @if( !is_null(Auth::user()->image) )
                        <img src="{{asset(Auth::user()->image)}}" alt="" class="rounded-circle header-profile-user">
                    @else
                        <img src="{{asset('backend/images/user.jpg')}}" alt="" class="rounded-circle header-profile-user">
                    @endif
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{url('/')}}"><i class=" ri-arrow-right-circle-line"></i> Go Page</a>
